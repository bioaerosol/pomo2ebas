...
class Nas(object):
    ...
    def set_fileglobal_metadata(self, station):
        ...
        self.nas.metadata.timezone = self.timezone
        ...
        for originator in station["originators"]:
            ...
            self.nas.metadata.originator.append(
                DataObject(
        ...
        for submitter in station["submitters"]:
            ...
            self.nas.metadata.submitter.append(
                DataObject(
    ...
    def set_time_axes(self, station, sample_times):
        ...
        self.nas.metadata.reference_date = datetime.datetime(self.nas.sample_times[0][1].year, 1, 1)
